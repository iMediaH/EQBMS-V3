<div id="g-rightbar">
    ...
    <div id="aqRB_main">
        <li><span class="aqRB_font">题型:</span><li class="aqRB_input"><select style="height:26px;" id="aqRB_select"><option><span style="font-size:18px;">多选题</span></option>
        ...
        <li><span class="aqRB_font">题目:</span><li class="aqRB_input"><textarea  style="width:50%; height:100px;">请入题目内容</textarea></li></li>
        
        <li class="aq_M"><span class="aqRB_font">添加选项:</span>
        ...
        <li class="aqRB_input"><input type="text" name="" id="aqRB_in1" style="width:15%; height:26px;" value="请入答案内容"/>
        <i class="icon-plus-sign icon-2x"></i>
        </li>
        </li>
        <li id="difficult"><span class="aqRB_font">难易度:</span>
          <li class="aqRB_input">
