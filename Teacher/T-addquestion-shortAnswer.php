<div id="g-rightbar">
	<div id="aqRB_head">
        <li><span style="font-size:17px"><span style="color:#0F0">>></span>HTML</span>
    ...
    <div id="aqRB_main">
        <li><span class="aqRB_font">题型:</span><li class="aqRB_input"><select style="height:26px;" id="aqRB_select">
...
<i class="icon-remove-sign icon-2x"></i>  -->
        ...
        <li class="aqRB_input"><textarea  style="width:40%; height:60px;">请入答案内容</textarea>
        </li>
        </li>
		<li id="difficult">
