...
<?php
	...
	$sql = "SELECT * from teacherinfo join courseinfo on teacherinfo.teacherid = courseinfo.teacherid join unitinfo on courseinfo.courseid = unitinfo.courseid join ".$_SESSION["M-table"]." on ".$_SESSION["M-table"].".unitid = unitinfo.unitid where typeid ='".$_SESSION["typeid"]."' order by questionid Asc limit $offset, $page_size";
