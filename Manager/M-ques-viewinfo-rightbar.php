...
?>
    <span style="color:#4caf50">>></span><span style="font-size:18px"> <?php echo $rows["TypeName"]; ?> </span><span style="color:#4caf50">>></span><span style="font-size:18px"> 查看题目 </span>
</div>
<hr>
<?php   //单选题 
    echo "<form action='M-ques-editinfo.php' >";
